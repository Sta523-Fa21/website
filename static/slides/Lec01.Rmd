...
|Assignment|Type      |Value  | n  |Assigned             |git
|:---------|:---------|:------|:---|---------------------|
...
- Accessible at https://github.com/Sta523-Fa21/Discussions/discussions (linked from course website) - you will need to join the course organization to gain access.
...
## RStudio .float-right[ .small[https://rstudio.stat.duke.edu:8787] ]

- Browser based, departmental RStudio instances
...
- We will be distributing a survey after class to collection your account names and then inviting you to the organization.
